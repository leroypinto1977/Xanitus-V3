    ...
    <div className="min-h-screen p-8 bg-slate-900 text-white">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-[#a0ff4a]">Roboto Mono Test (Headings)</h2>
          <p className="text-gray-300">This should be Sora font for body text</p>
          ...
          <div className="space-y-2">
            <div className="font-roboto-mono text-lg">Explicitly using font-roboto-mono class</div>
            <div className="font-sora text-lg">Explicitly using font-sora class</div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <span className="text-gray-400">Span text (Should be Sora via CSS)</span>
          </div>
        </div>
      </div>
    </div>
